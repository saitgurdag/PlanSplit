...
import com.example.plansplit.Adapters.CustomDialogAdapter;
import com.example.plansplit.Objects.Person;
import com.example.plansplit.R;
import com.example.plansplit.ui.ShareMethod.ShareMethodFragment;

import java.util.ArrayList;

public class GroupExpenseFragment extends Fragment {

    private GroupExpenseViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(GroupExpenseViewModel.class);
